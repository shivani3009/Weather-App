...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String BASE_URL = "https://api.openweathermap.org/"; // Base url of an api site
    private static final String API_KEY =  "d02245766bf16d40363e3975f06f5228"; // API KEY
